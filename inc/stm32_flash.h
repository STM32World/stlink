...
// == STM32H5 == (RM0481)
// H5 uses the same flash register block base as L5/U5, but the control/status
// bit layout differs.
#define STM32_FLASH_H5_REGS_ADDR STM32_FLASH_L5_REGS_ADDR
#define STM32_FLASH_H5_BANK2_REGS_ADDR ((uint32_t) 0x50022000)
#define STM32_FLASH_H5_NSKEYR (STM32_FLASH_H5_REGS_ADDR + 0x04)
#define STM32_FLASH_H5_SECKEYR (STM32_FLASH_H5_REGS_ADDR + 0x08)
#define STM32_FLASH_H5_OPTKEYR (STM32_FLASH_H5_REGS_ADDR + 0x0c)
#define STM32_FLASH_H5_NSSR (STM32_FLASH_H5_REGS_ADDR + 0x20)
#define STM32_FLASH_H5_SECSR (STM32_FLASH_H5_REGS_ADDR + 0x24)
#define STM32_FLASH_H5_NSCR (STM32_FLASH_H5_REGS_ADDR + 0x28)
#define STM32_FLASH_H5_SECCR (STM32_FLASH_H5_REGS_ADDR + 0x2c)
#define STM32_FLASH_H5_NSCCR (STM32_FLASH_H5_REGS_ADDR + 0x30)
#define STM32_FLASH_H5_SECCCR (STM32_FLASH_H5_REGS_ADDR + 0x34)
#define STM32_FLASH_H5_BANK2_NSSR (STM32_FLASH_H5_BANK2_REGS_ADDR + 0x20)
#define STM32_FLASH_H5_BANK2_NSCR (STM32_FLASH_H5_BANK2_REGS_ADDR + 0x28)
#define STM32_FLASH_H5_BANK2_NSCCR (STM32_FLASH_H5_BANK2_REGS_ADDR + 0x30)

#define STM32_FLASH_H5_NSCR_LOCK 0
#define STM32_FLASH_H5_NSCR_PG 1
#define STM32_FLASH_H5_NSCR_SER 2
#define STM32_FLASH_H5_NSCR_BER 3
#define STM32_FLASH_H5_NSCR_FW 4
#define STM32_FLASH_H5_NSCR_STRT 5
#define STM32_FLASH_H5_NSCR_SNB 6
#define STM32_FLASH_H5_NSCR_SNB_MASK (0x7fu << STM32_FLASH_H5_NSCR_SNB)
#define STM32_FLASH_H5_NSCR_MER 15
#define STM32_FLASH_H5_NSCR_BKSEL 31

#define STM32_FLASH_H5_NSSR_BSY 0
#define STM32_FLASH_H5_NSSR_WBNE 1
#define STM32_FLASH_H5_NSSR_DBNE 3
#define STM32_FLASH_H5_NSSR_EOP 16
...
#define STM32_FLASH_H5_NSSR_ERROR_MASK ((1u << STM32_FLASH_H5_NSSR_WRPERR) | \
                                        (1u << STM32_FLASH_H5_NSSR_PGSERR) | \
                                        (1u << STM32_FLASH_H5_NSSR_STRBERR) | \
                                        (1u << STM32_FLASH_H5_NSSR_INCERR) | \
                                        (1u << STM32_FLASH_H5_NSSR_OPTCHANGEERR))
#define STM32_FLASH_H5_NSCCR_CLEAR_MASK ((1u << STM32_FLASH_H5_NSSR_EOP) | \
                                         STM32_FLASH_H5_NSSR_ERROR_MASK)
